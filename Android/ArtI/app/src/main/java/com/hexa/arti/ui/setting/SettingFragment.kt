...
class SettingFragment : BaseFragment<FragmentSettingBinding>(R.layout.fragment_setting) {
    ...
    override fun init() {
        ...
        with(binding){
            ...
            settingViewPager.registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback() {
                override fun onPageSelected(position: Int) {
                    ...
                    when (position) {
                        0 -> {
                            settingPortfolioTv.setTextAppearance(requireContext(), R.style.SelectTextTitle)
                            settingMyPageTv.setTextAppearance(requireContext(), R.style.UnSelectTextTitle)
                        ...
                        1 -> {
                            settingPortfolioTv.setTextAppearance(requireContext(), R.style.UnSelectTextTitle)
                            settingMyPageTv.setTextAppearance(requireContext(), R.style.SelectTextTitle)
